        ...
        private
          ...
          def associate_records_to_owner(owner, records)
            ...
            if reflection.collection?
              ...
              ActiveRecord::Base.logger.debug "Associating #{records.inspect} to #{owner.inspect}"
            else
              association.target = records.first
              ActiveRecord::Base.logger.debug "Associating #{records.first.inspect} to #{owner.inspect}"
            end
          end
